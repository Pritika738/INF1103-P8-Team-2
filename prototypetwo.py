...
- No file operations here (the demo block's mock-file loader is the
  one exception, and it is isolated inside __main__ too).
...
if __name__ == "__main__":
    ...
    print(f"--- Simulating a record loaded from {MOCK_AI_OUTPUT_PATH} ---")
